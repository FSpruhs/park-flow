...
class InvoiceServiceTest {
    ...
    @Test
    fun `invoice should invoice correct when parked wrong`(): Unit = runBlocking {
        ...
        val history = VehicleHistoryReflection(
            ...
            history = listOf(
                ...
                HistoryItem(Instant.now().plusMillis(200), HistoryType.PARKED_ON_WRONG, parkingSpotId = "456"),
